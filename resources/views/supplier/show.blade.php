<x-layouts.app>
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
            ...
            <div class="flex items-center gap-3">
                <button type="button" class="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 shadow-sm text-sm font-medium rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
                    <i class="ph ph-file-arrow-down text-lg text-gray-500"></i>
                    Import
                </button>
                <button type="button" class="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 shadow-sm text-sm font-medium rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
                    <i class="ph ph-file-arrow-up text-lg text-gray-500"></i>
                    Export
                </button>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            {{-- Todo: add thickness using data from layers --}}
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">0</td> 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button onclick="openModal('editLayupModal');prepareEditModal({{ $layup->id }}, '{{ addslashes($layup->name) }}')" class="p-1.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Edit">
    ...
    <x-layup.modal-update></x-layup.modal-update>
